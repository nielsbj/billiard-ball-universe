...
\newcommand{\ellipball}[3]{%
  ...
  \begin{scope}\clip (#1,#2) circle (#3);\node at (#1,#2) {\includegraphics[width=\ew cm]{cover_ball.png}};\end{scope}}
...
\begin{tikzpicture}[x=1cm,y=1cm]
  ...
  \begin{scope}
    ...
    \node at (4.32,7.68) {\includegraphics[width=7.3cm]{cover_ball.png}};
  \end{scope}
  ...
  % vortex -> ellipsis: source ring + single tapering line
  \draw[ink,line width=0.45pt] (3.34,1.23) circle (0.16);
  \draw[ink,line width=0.4pt] (3.20,1.19) -- (2.60,1.05);
