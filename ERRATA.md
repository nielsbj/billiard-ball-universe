...
correction reaches the next printing. Each entry names the printing it first applies to, so a
reader can tell which corrections their copy already contains.

| Date | Printing affected | Location | Correction | Record |
|------|-------------------|----------|------------|--------|
| —    | —                 | —        | (none yet) | —      |
