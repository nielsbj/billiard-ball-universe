...
And here the \Ix{pincer} closes, because the rescue feeds the second monster. The flux does not only push bodies; it must \emph{deposit energy} in them --- that is what being absorbed or scattered means; you cannot take momentum from a stream without taking some of its punch. Speed the flux up to save the orbits, and every absorption delivers more energy. The nineteenth century did this arithmetic --- Maxwell pressed the objection~\cite{maxwell1875}, and Poincaré finally ran the numbers to the end~\cite[517--522]{poincare1908} --- and the verdict was not a discrepancy but an absurdity: a flux energetic enough to produce the gravity we measure, moving fast enough to spare the orbits we see, would heat the Earth at a rate that would vaporize it --- not over ages, but promptly.
