...
\enlargethispage{\baselineskip}% P11b: the box grew 6 lines and no longer fits folio 94 by ~20pt; one line of slack keeps it on its page. Remove if the box ever shortens.
\begin{center}
...
\begin{tikzpicture}[>=stealth]
  ...
  % 2.2cm wraps both lines in two, so this node is 4 lines and ~2cm tall; centred at
  % 3.05 its top reached y=4.07 and the momentum arrow at y=3.9 struck "the gap:".
  \node[anchor=east, align=center, text width=2.2cm] at (2.05,2.72)
