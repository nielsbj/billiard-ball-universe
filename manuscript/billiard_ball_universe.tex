...
The first: the object of this ethics was never your own multiplication. It is the emotions of the universe --- the ratio, wherever you can reach it --- that are to be tended. A hard life does not revoke that assignment, and, crucially, it does not disqualify you from it. A person in pain who spares another person pain has improved the ratio exactly as much as a happy person who did the same --- arguably more, since it was bought dearer. The task is not ``be happy''; the task is ``make the reachable region better than it would have been.'' Suffering does not exempt you from the task. It rarely prevents anyone from performing it, and some of the largest improvements in the reachable regions of this world were made by people who were themselves in pain the whole time.
