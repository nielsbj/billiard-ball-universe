# PROSE_PATCHES_saturationfig.md — the Sixth Wound gets its figure
*For code-claude. Niels has seen the studio's plate and ruled it in, so the conditional commission is now unconditional. Applies on top of 1479a97. Build-tested here with stand-in files (see caveat below): both editions, 0 errors, 0 overfull.*
